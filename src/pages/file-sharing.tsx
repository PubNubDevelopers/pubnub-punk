      ...
      <div className="max-w-6xl mx-auto">
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-pubnub-text mb-2">File Sharing Tool</h3>
            <p className="text-gray-600 mb-6">Test file upload, download, and sharing capabilities</p>
