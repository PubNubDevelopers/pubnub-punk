      ...
      <div className="max-w-6xl mx-auto">
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-pubnub-text mb-2">PubNub Persistence Tool</h3>
            <p className="text-gray-600 mb-6">Manage message storage and retrieval</p>
