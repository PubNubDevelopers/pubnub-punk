      ...
      <div className="max-w-6xl mx-auto">
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-pubnub-text mb-2">Presence Tool</h3>
            <p className="text-gray-600 mb-6">Monitor and test user presence and occupancy</p>
